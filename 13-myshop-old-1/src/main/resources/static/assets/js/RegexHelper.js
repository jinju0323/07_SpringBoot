...
class RegexHelper {
    ...
    /**
     * 라디오나 체크박스가 선택되었는지 검사한다.
     * @param {string} selector 검사할 CheckBox에 대한 selector
     * @param {siring} msg      검사에 실패할 경우 표시할 메시지
     */
    check(selector, msg) {
    ...
    /**
     * 숫자로만 이루어 졌는지 검사하기 위해 selector()을 간접적으로 호출한다.
     * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
     * @param {string} msg      표시할 메시지
     */
    num(selector, msg) {
    ...
    /**
     * 영문으로만 이루어 졌는지 검사하기 위해 selector()을 간접적으로 호출한다.
     * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
     * @param {string} msg      표시할 메시지
     */
    eng(selector, msg) {
    ...
    /**
     * 한글로만 이루어 졌는지 검사하기 위해 selector()을 간접적으로 호출한다.
     * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
     * @param {string} msg      표시할 메시지
     */
    kor(selector, msg) {
    ...
    /**
    * 영문과 숫자로 이루어 졌는지 검사하기 위해 selector()을 간접적으로 호출한다.
    * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
    * @param {string} msg      표시할 메시지
    */
    engNum(selector, msg) {
    ...
    /**
    * 한글과 숫자로 이루어 졌는지 검사하기 위해 selector()을 간접적으로 호출한다.
    * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
    * @param {string} msg      표시할 메시지
    */
    korNum(selector, msg) {
    ...
    /**
    * 이메일주소 형식인지 검사하기 위해 selector()을 간접적으로 호출한다.
    * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
    * @param {string} msg      표시할 메시지
    */
    email(selector, msg) {
    ...
    /**
    * 핸드폰 번호 형식인지 검사하기 위해 selector()을 간접적으로 호출한다.
    * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
    * @param {string} msg      표시할 메시지
    */
    ...
    /**
    * 집전화 형식인지 검사하기 위해 selector()을 간접적으로 호출한다.
    * @param {string} selector 검사할 대상에 대한 <input>요소의 selector
    * @param {string} msg      표시할 메시지
    */
