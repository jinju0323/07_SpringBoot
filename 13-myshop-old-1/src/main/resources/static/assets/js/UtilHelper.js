...
class UtilHelper {
  ...
  async confirm(title, text, icon, confirmButtonText, confirmButtonColor, cancelButtonText, cancelButtonColor) {
    if (Swal != undefined) {
      return await Swal.fire({
        title: title,
        text: text,
  ...
  async confirmPrimary(title, text, confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.alert(title, text, confirmButtonText, this.colorMap.primary, cancelButtonText);
  }

  async confirmSuccess(title, text, confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.alert(title, text, confirmButtonText, this.colorMap.uccess, cancelButtonText);
  }

  async confirmDanger(title, text, confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.alert(title, text, confirmButtonText, this.colorMap.danger, cancelButtonText);
  }

  async confirmWarning(title, text, confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.alert(title, text, confirmButtonText, this.colorMap.warning, cancelButtonText);
  }

  async confirmInfo(title, text, confirmButtonText = "확인", cancelButtonText = "취소") {
    return await this.alert(title, text, confirmButtonText, this.colorMap.info, cancelButtonText);
  }
}
